...
import { increaseQuantity, decreaseQuantity, removeFromCart, clearCart, addOrder } from "../../redux/CartSlice";
...
function Cart() {
    ...
    const handleConfirmOrder = () => {
        ...
        else if (modalType === "single" && selectedItem) {
    ...
    const orderDetails = {
        id: Date.now(),
        items: modalType === "all" ? [...cartItems] : selectedItem ? [selectedItem] : [],
        total:
          modalType === "all"
            ? calculateTotal(cartItems)
            : selectedItem
            ? selectedItem.price + deliveryCharge + packingCharge
            : 0,
    ...
    return (
        <div className="p-6">
            ...
            <h1 className="text-2xl mt-10 text-center text-green-500 font-bold mb-20">🛒 Your Cart</h1>
                            ...
                            <div
                                ...
                                <div className="flex items-center space-x-2">
                                    <button
                                        ...
                                        className="px-2 py-1 bg-gray-200 rounded-lg hover:bg-gray-300">-</button>
                            ...
                            selectedItem && (
                                <>
                                    ...
                                    <div className="space-y-2">
                                        <p>
                                            <strong>{selectedItem.name}</strong> × {selectedItem.quantity}
                                        </p>
                                        <p>
                                            Item Total:{" "}
                                    ...
                                    {/* Extra charges for seperate item */}
                                    <div className="mt-4 space-y-1 text-sm">
                                        <p className="flex justify-between">
                                            <span>Delivery Charge:</span> <span>₹{deliveryCharge}</span>
                                        </p>
                                        ...
                                        <p className="flex justify-between font-bold text-lg">
                                            <span>Total:</span>{" "}
                                            <span>₹{selectedItem.price * selectedItem.quantity +
                                                deliveryCharge +
                                                packingCharge}
                                            </span>
                                        </p>
